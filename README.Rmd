...
number first, but it'll serve as my prior information. I messed around with `a` 
and `b` until I got the follow prior, which is peaked around .1-ish and keeps .5
